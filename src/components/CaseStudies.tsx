...
const caseStudies: CaseStudy[] = [
  ...
  {
    title: "Road Asset Management System",
    description:
  ...
  },
  {
    title: "Rehnuma Awaaz",
    description:
      "A provincial government wanted to survey, catalogue, and manage one of the country's largest road networks. We built the platform and the AI survey module inside it. Car-mounted cameras detecting potholes, identifying damage, and cataloguing assets automatically from video footage.",
    boldPhrases: [],
    image: "/rehnuma.png",
  },
];
