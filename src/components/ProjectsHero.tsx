...
export default function ProjectsHero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      tl.from(".projects-hero-title", { y: 32, opacity: 0 }).from(
        ".projects-hero-sub",
        { y: 32, opacity: 0 },
        "-=0.5"
      );
  ...
  return (
    <section
      ref={sectionRef}
      className="flex flex-col items-center text-center px-6 pt-[130px] md:pt-[180px] pb-[70px] md:pb-[100px]"
    >
      <h1
        ...
        style={{
          ...
          fontWeight: 600,
          fontSize: "clamp(34px, 8.24vw, 118.58px)",
          lineHeight: "112.8%",
        }}
      >
        Where Great Ideas
